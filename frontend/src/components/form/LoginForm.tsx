...
import { login, type SignupCredentials } from "../../network/notes.api";
        ...
        <div className="bg-f-white dark:bg-f-neutral-950 p-[48px] rounded-[12px] outline-1 outline-f-neutral-100 dark:outline-f-neutral-800 flex flex-col items-center lg:min-w-[540px] md:min-w-[522px] sm:min-w-[343px]">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="w-full pt-[40px]">
                <div className="flex flex-col gap-[6px] w-full">
                 ...
                 <div  className="flex flex-col gap-[6px] pt-4 pb-4">
                   ...
                   <div className="relative">
                    ...
                    {showPassword ? (
              <EyeOff
                className="absolute top-1/2 -translate-y-1/2 right-4 text-f-neutral-500 dark:text-f-neutral-500 w-[17px] h-auto cursor-pointer"
              ...
              />
                ...
                <PrimaryButton type="submit" disabled={isSubmitting} className="w-full ">Login</PrimaryButton>
            </form>
            ...
            <div className="border-t-1  border-f-neutral-200 dark:border-f-neutral-800 w-full flex items-center justify-center mt-4 pt-4">
                <p className="text-preset-5 text-f-neutral-600 dark:text-f-neutral-300">No account yet? <button className="text-preset-5 text-f-neutral-950 dark:text-f-white cursor-pointer" onClick={() => onShowSignup()}>Sign up</button></p>
            </div>
