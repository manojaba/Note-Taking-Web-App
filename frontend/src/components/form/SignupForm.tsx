...
import { signup, type SignupCredentials } from "../../network/notes.api";
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="w-full pt-[40px]">
                <div className="flex flex-col gap-[6px] w-full">
                 ...
                 <div  className="flex flex-col gap-[6px] pt-4 pb-4">
                    <label className="text-preset-4 text-f-neutral-950 dark:text-f-white">Password</label>
                   <div className="relative  ">
                     <input type={showPassword ? 'text' : "password"} className="w-full outline-1 outline-f-neutral-300 dark:outline-f-neutral-600 rounded-[8px] px-4 py-3 bg-f-white dark:bg-f-neutral-950 placeholder:text-f-neutral-500 placeholder:text-[14px] placeholder:font-normal placeholder:leading-1.5 placeholder:tracking-[-0.2px] text-f-neutral-950 dark:text-f-white" {...register('password',{required:'Required'})}></input>
                    {showPassword ? (
              <EyeOff
                className="absolute top-6  -translate-y-1/2 right-4 text-f-neutral-500 dark:text-f-neutral-500 w-[17px] h-auto cursor-pointer"
              ...
              />
                    ...
                    <p className="text-f-neutral-600 dark:text-f-neutral-400 text-preset-6 pt-[6px] flex items-center gap-2"><CircleAlert className="w-3 h-3"/>At least 8 characters</p>
                   </div>
                    { 
                ...
                <PrimaryButton type="submit" disabled={isSubmitting} className="w-full ">Signup</PrimaryButton>
            </form>

            <div className="border-t-1  border-f-neutral-200 dark:border-f-neutral-800 w-full flex items-center justify-center mt-4 pt-4">
                <p className="text-preset-5 text-f-neutral-600 dark:text-f-neutral-300">Already have an account? <button className="text-preset-5 text-f-neutral-950 dark:text-f-white cursor-pointer" onClick={() => onShowLogin()}>Login</button></p>
            </div>
